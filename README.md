...
| [docs/14-reference-planet-shader.md](docs/14-reference-planet-shader.md) | The vendored planet shader: how it traces a sphere, the two changes we made, and what it replaced |
