extends "res://assets/vendor/pixel_planets/Planet.gd"
# From Deep-Fold/PixelPlanets (https://github.com/Deep-Fold/PixelPlanets),
# MIT licensed, copyright (c) 2020 Deep-Fold. See the LICENSE beside this
# file and docs/14-reference-pixel-planets.md. Unmodified except for this
# header and, in the scenes, repointed resource paths.
